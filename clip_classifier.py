...
class CLIPWithProjectionHead(nn.Module):
    def __init__(self, base_model_name="openai/clip-vit-base-patch32", freeze_base=False, device='cuda'):
        super().__init__()
        ...
        if freeze_base:
            ...
            for param in self.clip.vision_model.encoder.layers[-2:].parameters():
